 ...
 * <p>
 * For simplicity, the {@link XListAdapter} wrapper class can often be used instead of the
...
public class XAsyncListDiffer<T> {
    ...
    final XAsyncDifferConfig<T> mConfig;
     ...
     * new MyAsyncDifferConfig.Builder().setDiffCallback(diffCallback).build());}
     *
    ...
    public XAsyncListDiffer(@NonNull RecyclerView.Adapter adapter,
        ...
        this(new AdapterListUpdateCallback(adapter),
                new XAsyncDifferConfig.Builder<>(diffCallback).build());
    }
    ...
    public XAsyncListDiffer(@NonNull ListUpdateCallback listUpdateCallback,
                            @NonNull XAsyncDifferConfig<T> config) {
