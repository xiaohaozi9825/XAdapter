...
val smartMenuList = arrayListOf(
    "Adapter创建",
    HomeInfo("创建单布局", "单布局创建方式", R.mipmap.icon_smart_single, SingleFragment::class.java),
    HomeInfo("创建多布局", "多布局创建方式", R.mipmap.icon_smart_multiple, MultipleFragment::class.java),
    "选择操作",
    HomeInfo("选择操作", "Item选择操作", R.mipmap.icon_smart_select, SelectFragment::class.java),
    "Item事件监听",
    ...
    HomeInfo("选中事件", "单选、多选等", R.mipmap.icon_smart_check, CheckFragment::class.java),
    HomeInfo("文本变化", "EditText文本变化监听", R.mipmap.icon_smart_text_change, TextChangeFragment::class.java),
    "特殊布局",
    HomeInfo("特殊布局", "如头布局，脚布局，空布局、缺省页", R.mipmap.icon_smart_special, SpecialLayoutFragment::class.java),
    HomeInfo("分组布局", "允许Item撑满整行", R.mipmap.icon_smart_group, GroupFragment::class.java),
    "拖拽与侧滑",
    ...
    HomeInfo("侧滑菜单", "类似QQ侧滑效果", R.mipmap.icon_smart_swipe_menu, SwipeMenuFragment::class.java),
    "数据操作",
    HomeInfo("常规操作", "数据增删改查", R.mipmap.icon_smart_data_operation, DataOperationFragment::class.java),
    HomeInfo("Differ", "使用Differ更新数据", R.mipmap.icon_smart_data_differ, DataDifferFragment::class.java),
    "其他",
    HomeInfo("协程作用域", "", R.mipmap.icon_smart_coroutine, CoroutineScopeFragment::class.java),
...
val exampleMenuList = arrayListOf<Any>(
    HomeInfo("好友列表", "仿QQ好友列表", R.mipmap.icon_example_friend, FriendFragment::class.java),
    HomeInfo("分类列表联动", "商品分类用与商品列表联动", R.mipmap.icon_example_goods_category, GoodsFragment::class.java),
    HomeInfo("多级分类列表", "商品分类多级菜单", R.mipmap.icon_example_goods_category,MultipleCategoryFragment::class.java),
    HomeInfo("图片选择器", "防微信图片选择器", R.mipmap.icon_example_image_selected,ImageSelectedFragment::class.java),
    HomeInfo("标签", "", R.mipmap.icon_example_tag),
