package pw.xiaohaozi.xadapter.utils.permission;
 ...
 * <p>
 * https://blog.csdn.net/L_201607/article/details/122963184
 */
public class JumpPermissionManagement {
    ...
    public static void Meizu(Context activity) {
        try {
            ...
            if (!(activity instanceof Activity)) intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
